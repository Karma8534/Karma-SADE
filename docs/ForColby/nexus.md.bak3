...
## Sprint 0: The Cascade Pipeline (sensors → actuators)

**Source:** Codex yoyo-evolve analysis (obs #22158) + Julian insertion mapping
**Full plan:** `.gsd/phase-cascade-pipeline-PLAN.md`
...
**Why this is Sprint 0:** Without actuators, every gap requires Julian in the wrapper. With actuators, gaps close overnight. This multiplies all subsequent sprints.

# Use OpenClaw to Make a Personal AI Assistant _ Towards Data Science

*Converted from: Use OpenClaw to Make a Personal AI Assistant _ Towards Data Science.PDF*
...
Talk to my Agent Smarter Model Tuning: An AI
...
Performance
Roni Dover
July 28, 2025 9 min read Automating model tuning in Python with
...
Using LangGraph and MCP Preventing Context Overload:
Servers to Create My Own Voice Controlled Neo4j MCP Cypher
Assistant Responses for LLMs
...
Built over 14 days, all locally run, no API How timeouts, truncation, and result
keys, cloud services, or subscription sanitization keep Cypher outputs LLM-
fees. ready
Benjamin Lee Tomaz Bratanic
September 4, 2025 30 min read September 7, 2025 4 min read
AGENTIC AI AUTHOR SPOTLIGHTS
How to Build Effective AI Agents Generalists Can Also Dig Deep
to Process Millions of Requests
Ida Silfverskiöld on AI agents, RAG, evals,
Learn how to build production ready and what design choice ended up
systems using AI agents mattering more…
Eivind Kjosbakken TDS Editors
September 9, 2025 9 min read September 12, 2025 6 min read
AGENTIC AI

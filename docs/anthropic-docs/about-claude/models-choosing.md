...
- **Speed:** How quickly does the model need to respond in your application? For Claude Opus 4.6, fast mode (beta: research preview) can provide up to 2.5x higher output speed at premium pricing.
...
- **Model comparison chart**: See detailed specifications and pricing for the latest Claude models at [/docs/en/about-claude/models/overview](/docs/en/about-claude/models/overview)
- **What's new in Claude 4.6**: Explore the latest improvements at [/docs/en/about-claude/models/whats-new-claude-4-6](/docs/en/about-claude/models/whats-new-claude-4-6)
- **Start building**: Get started with your first API call at [/docs/en/get-started](/docs/en/get-started)

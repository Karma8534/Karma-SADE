...
- 2026-04-25T02:31:00Z: Extended `frontend\scripts\stabilize-export.mjs` to sort the numeric dependency array inside generated app chunk wrappers, removing the last clean-build drift where identical `page.js` payloads differed only by `webpackChunk_N_E.push([[...` ID ordering.
- ritual_recording: ordered png sequence step-01 through step-12

...
- **Phase 2 shipped:** 23 slash commands (/convert new), StatusBar, WIP panel (/v1/wip), Settings, consolidation agent. Gap: 13 MISSING (was 70), 27 HAVE (was 8). 148 PDFs converted + inbox cleaned. auto_convert_pdfs.py for future drops.

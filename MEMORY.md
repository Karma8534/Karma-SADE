...
- **Phase 2 shipped:** 22 slash commands, StatusBar, WIP panel (with /v1/wip backend), Settings (theme/prefs/style), markdown messages. Gap: 13 MISSING (was 70), 27 HAVE (was 8). Primitives: consolidation loop (obs #22288, #22319). PDF batch convert pending (obs #22323).

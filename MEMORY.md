...
- **BUG FIX:** sync_k2_to_p1.py — missing encoding="utf-8" caused P1 state read to return 0 labels (P053). Before: full resync every run. After: delta-only (64/708 blocks).

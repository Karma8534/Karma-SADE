...
- **S160 shipped:** nexus.md v5.3.0. 3-TIER CASCADE. 42 commands (30 independent). Permission engine (42+7). Karpathy loop. SQLite dual-write in watchdog. 16/17 primitives deployed. 94 commits.

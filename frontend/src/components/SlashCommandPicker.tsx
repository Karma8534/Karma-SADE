...
const COMMANDS: SlashCommand[] = [
  ...
  { name: 'plugins', description: 'Show installed plugins and their status', category: 'tools' },
  ...
  { name: 'check-email', description: 'Check gmail inbox for new messages', category: 'tools' },
  ...
  { name: 'keys', description: 'Show all keyboard shortcuts', category: 'info' },
];

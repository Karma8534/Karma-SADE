...
- **Primary model is now claude-3-5-haiku-20241022** (Session 75, Decision #28): GLM-4.7-Flash retired from primary use. Both MODEL_DEFAULT and MODEL_DEEP = claude-3-5-haiku-20241022. Tool-calling routes through Anthropic SDK (isAnthropicModel=true for claude- prefix). GLM rate-limit code skips for claude- models automatically.

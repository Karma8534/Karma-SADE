...
## What We're Building
Wiring the brain (claude-mem on P1:37778) into the full stack:
...
- claude-mem running on P1:37778 ✅ (always on)
- P1 Tailscale IP: 100.124.194.102 ✅ (confirmed via B3 testing)

## Design Decisions Locked
1. **C1 approach TBD at execution**: first check if claude-mem supports --host binding. If yes: restart with --host 100.124.194.102. If no: hub-bridge /memory proxies to P1:37778 via Tailscale HTTP.
